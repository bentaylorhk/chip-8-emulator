...
extern std::array<uint8_t, 0x1000> RAM;

// 16 8-bit data registers named V0 to VF.
// V[F] is the control register.
extern std::array<uint8_t, 16> V;
...
// Stack stored statically using SP to access.
...
// Indexed function pointers.
constexpr std::array<Instruction, 16> OPCODES = {
